...
import { TrendingUp, TrendingDown, Clock, Target, Shield, DollarSign, MoreVertical, CheckCircle, XCircle, Trash2 } from 'lucide-react';
...
export const AlertCard: React.FC<AlertCardProps> = ({ alert, onUpdateStatus, onDelete }) => {
